...
function createTurnAuditRecords({
  ...
  const feedbackEvents = [
    ...
    buildFeedbackEvent(worldState, "official_court_consequence", "official_court_consequence_step", officialCourtConsequence),
    buildFeedbackEvent(worldState, "official_court_response", "official_court_response_step", officialCourtResponse),
    buildFeedbackEvent(worldState, "role_world_coupling", "role_world_coupling_step", roleWorldCoupling),
    buildFeedbackEvent(worldState, "role_cycle_domain_adjudication", "role_cycle_domain_adjudication_step", roleCycleDomainAdjudication),
    buildFeedbackEvent(worldState, "world_tick", "world_tick_step", worldTick),
    buildFeedbackEvent(worldState, "npc_economy", "npc_economy_tick", npcEconomy),
