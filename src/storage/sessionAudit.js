...
const SENSITIVE_AUDIT_KEY_PATTERN =
  /(apiKey|api_key|token|secret|password|credential|prompt|promptText|instructions|worldState|relationshipLedger|worldPeople|worldPostings|officialPostings|npcs|households|assets|estates|relationships|postings|assessmentRecords|transferRecords|hidden|hiddenNotes|stack|filePath|path|databasePath|sessionsDir|sqliteDatabasePath)/i;
