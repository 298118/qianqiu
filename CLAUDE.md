...
Before implementing anything, read [docs/QIANQIU_DEVELOPMENT_BRIEF.md](docs/QIANQIU_DEVELOPMENT_BRIEF.md). Treat it as the canonical project brief for architecture, scope, gameplay, AI contracts, and development discipline.
