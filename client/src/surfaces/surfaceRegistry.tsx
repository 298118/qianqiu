...
export const surfaceRegistry: Record<LocalSurface, SurfaceRegistryEntry> = {
  ...
  "edict-draft": {
    ...
    dataSource: "安全数据来源：officialPostingsView、eventArchiveView、worldThreadView、mapRuntimeView 摘要和玩家公开身份。",
  ...
  "court-debate": {
    ...
    dataSource: "安全数据来源：officialPostingsView、actorMemoryView、aiControlAuditView、eventArchiveView、worldThreadView 的公开摘要。",
  ...
  trial: {
    ...
    dataSource: "安全数据来源：localAffairsDocketView、eventArchiveView、safeWorldSearchView 和玩家辖区公开摘要。",
  ...
  "war-council": {
    ...
    dataSource: "安全数据来源：militaryDiplomacyView、mapRuntimeView、eventArchiveView、officialPostingsView 和公开边患摘要。",
