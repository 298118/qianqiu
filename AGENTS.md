...
- Backend: Node.js + Express, currently CommonJS JavaScript with a gradual TypeScript migration for contracts, route/API response shapes, safe views, AI schemas, storage adapters, and core resolvers; adapter-based AI providers.
