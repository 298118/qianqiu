...
- 当前默认存储仍是本地 JSON。可选 SQLite 目前已有 session row、审计表和 JSON `world_state`，但国家/城市、NPC/家族/资产/关系、官职任所和安全事件索引尚未拆成 SQLite 业务表；这些已拆入 S54-S59 规划。远程存档、账号体系、多人同步和云端数据库不属于当前范围。
