...
- 存储：本地 JSON session 文件，位于 `data/sessions/`；S38.2 已记录后续 schema envelope、原子写入、并发保护、存档列表、清理和数据库迁移规划。
...
- [docs/SESSION_STORAGE_MIGRATION_PLAN.md](docs/SESSION_STORAGE_MIGRATION_PLAN.md)：S38.2 存档 schema、原子写入、并发保护、存档列表、清理和数据库迁移规划。
