...
- 游戏与考试路由会返回 `examCalendarView`、`examRivalView`、`relationshipView`、`activeNpcRequestView`、`roleWorldCouplingView`、`longTermEventView`、`officialCareerView` 等视图；其中 `officialCareerView` 已用于浏览器官场面板，展示官署、差事、考成、关系摘要和弹劾流程摘要。
...
- 长期事件、官场结果、科举日历和角色世界联动仍是确定性规则集；S42.3 已让入仕后可在浏览器中查看官署、差事、考成、关系和风险，后续仍可把差事接入 S43 World Threads 的跨月议题。
