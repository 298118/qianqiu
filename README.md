...
当前项目已经完成可玩纵切、浏览器验收、时间专项、AI provider 扩展、本地动态数据库基础、S54-S59 SQLite 业务表拆分、S60-S67 超大动态世界数据库内容充实、S68-S69 科举读书深化与归档、S70 AI 编排归档，以及 S71.0-S71.6 数据库 resolver 输入、本地 SQLite 维护层、安全全文检索、redacted player API、财政/城市政策服务器裁决和地方案件/刑名服务器裁决。近期重点更新集中在“本地数据库专项归档”“S68-S69 科举读书深化”“多 provider 能力”“S70 AI 编排”和“S71 数据库玩法化入口”：
...
- [docs/DEVELOPMENT_STEPS.md](docs/DEVELOPMENT_STEPS.md)：当前活动路线图与进度台账，已交接到 S71；下一步从 S71.7 军务与外交 resolver 继续。
...
- “超大动态世界数据库”的 S60-S67 内容充实阶段已并入统一归档；S68-S69 科举深化和 S70 AI 编排也已归档，S71.0-S71.6 已固定 resolver 输入边界、落地只读 `resolverInputContext`、补本地 SQLite migration/maintenance、安全全文检索、redacted player API、开发诊断 API、财政/城市政策服务器裁决与地方案件/刑名服务器裁决；后续活动重点进入军务外交、压力事件、NPC 记忆和 AI 调动审计面板。
