...
- 后端：Node.js + Express，当前以 CommonJS JavaScript 为主；S86 起渐进迁移到 TypeScript，优先覆盖契约、API/view 类型、安全 projection、AI schema/provider facade、storage adapter 和核心 resolver，不做全仓重写，TS 类型也不能替代 Ajv 与服务器 runtime 校验。
