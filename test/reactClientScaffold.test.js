...
test("S79.3 portrait viewer stays read-only and uses audited runtime portrait paths", () => {
  ...
  assert.match(styleSource, /@keyframes peoplePortraitGalleryUnroll/);
  assert.match(styleSource, /@keyframes peoplePortraitReadoutSlipRise/);
  assert.match(styleSource, /peopleGalleryBand\[data-polish-people-gallery-band="s89-35-people-portrait-gallery"\][\s\S]*animation: peoplePortraitGalleryUnroll 520ms ease both/);
  assert.match(styleSource, /peopleGalleryReadout dl[\s\S]*animation: peoplePortraitReadoutSlipRise 420ms ease both/);
  assert.match(styleSource, /portraitViewerDossierRail[\s\S]*animation: peoplePortraitReadoutSlipRise 420ms ease both/);
  ...
  assert.match(styleSource, /@keyframes portraitViewerCueTagLift[\s\S]*translateY\(8px\)/);
  assert.match(styleSource, /portraitViewerCueGrid span[\s\S]*animation: portraitViewerCueTagLift 420ms ease both/);
  assert.match(styleSource, /\.appShell\[data-motion="reduced"\][\s\S]*\.portraitViewerCueGrid span/);
  assert.match(readText("scripts/clientSmoke.js"), /peoplePortraitGalleryUnroll/);
  assert.match(readText("scripts/clientSmoke.js"), /peoplePortraitReadoutSlipRise/);
  assert.match(readText("scripts/clientSmoke.js"), /portraitViewerCueTagLift/);
  assert.doesNotMatch(styleSource, /@keyframes s(?:8935(?:GalleryUnroll|SlipRise)|899CueLift)|animation(?:-name)?: s(?:8935(?:GalleryUnroll|SlipRise)|899CueLift)/);
  assert.doesNotMatch(readText("scripts/clientSmoke.js"), /s8935GalleryUnroll|s8935SlipRise|s899CueLift/);
