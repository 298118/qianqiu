...
- Active roadmap: S49-S67 本地数据库与大世界内容已统一归档，S68-S69 科举、读书、评卷、榜单、同年座师、授官和 Provider/Mock 验收已归档。S70.1 AI prompt pack 与工具协议契约、S70.2 actor 权限模型、S70.3 内部 `game_ai_tools` registry/runner 和 S70.4 NPC mind 基础已实现，下一步进入 S70.5 制度 AI 与朝议/科场场景。S71 已作为 S70 后的数据库玩法化、维护、安全检索和 redacted API 专项挂入台账，不抢占 S70。
...
启动 S70.5：制度 AI 与朝议/科场场景。重点基于 S70.2 actor profile、S70.3 runner 和 S70.4 NPC proposal 形状，组织官署、派系、大臣、谏官、老师与考官的 scene-local 多 actor 轮次；先做安全场景 context、参与者权限、proposal 汇总和 Mock/no-key fallback，真实制度后果仍由服务器 resolver 裁决。
