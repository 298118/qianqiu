...
Continue S61.2: connect the new city depth metrics to visible event archive / official assessment summaries, or add the larger city fixture and browser pagination gates needed before S66/S67 scale checks.
