...
若继续前端产品化打磨，下一候选为 S89 polish 阶段归档、舆图/人物/史册更深的证据读法玩家化、更多 route 空态一致性 polish，或继续做小批量 CSS/JS 预算专项。
