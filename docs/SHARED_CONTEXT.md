...
Start S62.2 NPC lifecycle and asset flow. S66.2 can later use the S62.1 population/genealogy projection plus the S60.2 fixture/page helper to build real browser search, filtering, pagination, and hidden-token smoke for large information panels.
