...
Continue S61.2/S66: add larger city fixture and browser pagination gates, or add dual-mode `event_archive_index` / `prompt_retrieval_index` pollution tests for S61 official-assessment summaries before S66/S67 scale checks.
