...
After S45.2 commit/hash backfill, start S46.1 dependency/plugin governance template or a small S45 follow-up for role-scoped entity visibility/UI noise control.
