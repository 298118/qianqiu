...
- Geography, people, official postings, local affairs dockets, event archive, audit public projection: `src/game/worldGeography.js`, `src/game/worldPeople.js`, `src/game/officialPostings.js`, `src/game/localAffairsDockets.js`, `src/game/eventArchive.js`, `src/game/auditPublicProjection.js`
...
Start S64.1 diplomacy, frontier, and military database content. S66.2 can later use the S62/S63 projections plus the S60.2 fixture/page helper to build real browser search, filtering, pagination, and hidden-token smoke for large information panels.
