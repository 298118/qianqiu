...
After S48.3, begin S48.4 from `docs/DEVELOPMENT_STEPS.md`: establish scene-local time and prioritize a multi-stage exam flow so opening/reviewing/drafting/writing an exam advances exam-local phases rather than consuming global ten-day periods. Keep development rules unchanged.
