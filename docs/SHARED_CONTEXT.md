...
Start S63.1 official ecosystem and appointment pool. S66.2 can later use the S62.1/S62.2 people projection plus the S60.2 fixture/page helper to build real browser search, filtering, pagination, and hidden-token smoke for large information panels.
