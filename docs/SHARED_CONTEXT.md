...
Start S58.1: let `promptContextAssembler` use SQLite indexes in SQLite mode while keeping JSON fallback, view-first contracts, and hidden-row / raw-audit leakage tests.
