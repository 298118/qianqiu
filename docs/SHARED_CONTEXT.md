...
5. Respect any existing uncommitted changes.
...
2. Update `docs/QIANQIU_DEVELOPMENT_BRIEF.md` or README when the durable project contract changes.
3. Run the relevant verification command.
4. Commit the change locally.
5. Mention the commit hash in the final response.
