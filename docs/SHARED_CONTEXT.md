...
- Roadmap status: S49-S67 本地数据库与大世界内容、S68-S69 科举深化、S70 AI 编排、S71 数据库玩法化、S72 PixiJS 水墨地图、S73-S77 前端水墨重构、S78 官署专题玩法化、S79 前端修复与高清立绘使用、S80 服务端全局 AI 设置均已完成并归档或压缩记录。S81-S85 NPC、资产、储物、交易、委派、经济、NPC 主动性和礼法扩展位已完成首轮闭环并归档。S86 后端 TypeScript 渐进迁移首轮与 S87 route/API 响应类型覆盖已完成并归档。当前活动专项为 S88 全面系统打磨，规划见 `docs/QIANQIU_POLISHING_ROADMAP.md`；首个实施切片 S88.1 聚焦 AI remote helper/provider public-safe envelope，下一小步建议 S88.2 SQLite derived row builder 类型边界。
...
下一步建议进入 S88.2：覆盖 SQLite derived row builder 类型边界，优先固定 `SqliteWorldSessionRow`、`prompt_retrieval_index`、`safe_search_index`、repair status 和首批 row builder JSDoc/TS contract。继续保持派生表只从 `world_sessions.world_state_json -> server views` 单向修复，不让 AI、浏览器、prompt 或服务器 resolver 把 raw SQLite 行当作事实源。
