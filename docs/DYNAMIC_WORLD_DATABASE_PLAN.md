...
- S55：人物业务表。S55.1 已定义 `people_npcs`、`people_households`、`people_assets`、`people_estates`、`people_relationships`；后续接入 `worldPeopleView` parity、NPC 生命周期、财富/家产/关系事件和审计关联。
