...
| 馆选/观政/铨选 | 殿试后按甲第、名次、缺额和回避入翰林、观政或外放 | S69.3 进入 `appointmentTrackView` | 官缺、回避、授官、候缺和官职事实 |
...
吏部和皇帝 AI 可以提交任用倾向；服务器结合甲第、名次、官缺、籍贯回避、朝局、声望、舞弊疑点和 `officialPostingsView` 写入真实官职。
