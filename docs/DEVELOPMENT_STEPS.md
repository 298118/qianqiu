...
| S71.0 | DONE | 科举、读书、评卷与授官深化提前规划：制度细节、AI 老师/考官、名次荣誉、馆选铨选和验收矩阵 | 2026-05-08 | Codex / 子代理 | 本次文档提交 |
| S71.1 | TODO | 科举制度契约：明清原型、游戏压缩、保结/搜检/弥封/誊录/磨勘/复核/号舍流程与 AI/server 权限 | - | - | S70/S71 启动后 |
| S71.2 | TODO | 读书画像与老师 AI：个性化读书计划、文卷弱点、书目、小题训练、老师/书院/同年影响 | - | - | S71.1 后 |
| S71.3 | TODO | 考试程序深化：童试内部分段、乡试/会试多场、殿试问策和 scene-local 科场流程 | - | - | S71.2 后 |
| S71.4 | TODO | 科场事件与同年竞争：保结人情、搜检误会、号舍压力、誊录错字、传闻、同年互动 | - | - | S71.3 后 |
| S71.5 | TODO | 多考官评卷：房官/同考官/主考/critic AI proposal 与服务器 canonical ranking resolver | - | - | S71.4 后 |
| S71.6 | TODO | 名次与荣誉体系：解元、会元、状元、榜眼、探花、传胪、三元和榜单长期关系 | - | - | S71.5 后 |
| S71.7 | TODO | 授官与入仕深化：馆选、庶吉士、观政、铨选、候缺、外放、籍贯回避和缺额/朝局 resolver | - | - | S71.6 后 |
| S71.8 | TODO | 浏览器科举面板深化：读书计划、科场流程、榜单荣誉、授官轨迹和 hidden-token smoke | - | - | S71.7 后 |
| S71.9 | TODO | Provider/Mock 验收：真实 provider 出题/评卷/点评 smoke、Mock deterministic 路径和越权红队 | - | - | S71.8 后 |
| S71.10 | TODO | S71 归档与交接：科举深化实现归档、brief/context/验收更新和下一阶段建议 | - | - | S71.9 后 |
...
## 15. S71：科举、读书、评卷与授官深化

S71 是书生主线的深度专项，详细提前规划见 [IMPERIAL_EXAM_DEEPENING_ROADMAP.md](IMPERIAL_EXAM_DEEPENING_ROADMAP.md)。当前系统已经能完成四级科举和殿试入仕，但仍是压缩版；S71 的目标是把读书、老师、科场、评卷、榜单和授官做成长期制度生涯。
...
- 明清科举制度作为主要原型，但只复刻能形成玩法的制度：保结、搜检、贡院号舍、弥封、誊录、磨勘、复核、多考官阅卷、名次荣誉、馆选、庶吉士、观政、铨选、候缺、外放和籍贯回避。
...
- 科场流程：报名保结、入场搜检、号舍作答、弥封誊录、阅卷磨勘、放榜复核全部使用 scene-local time。
...
步骤：S71.0 科举、读书、评卷与授官深化提前规划

提交：本次文档提交。

完成：

- 新增 [IMPERIAL_EXAM_DEEPENING_ROADMAP.md](IMPERIAL_EXAM_DEEPENING_ROADMAP.md)，把保结、搜检、贡院号舍、弥封、誊录、磨勘、复核、多考官阅卷、解元/会元/状元/榜眼/探花、馆选、庶吉士、观政、铨选、候缺和外放写成 S71 专项规划。
- 将 AI 个性化读书计划、老师点评、书院/同年、科场事件、房官/主考/critic AI、服务器 canonical ranking 和授官 resolver 的边界写入活动台账。
- 明确 S71 不改当前运行时代码，后续实现仍必须保护完整书生路径、Mock/no-key、AI 不直写官职/榜单/授官和服务器最终裁决。
...
- 当前工作树已有 S63.2 未提交改动；本次提交需要只暂存 S71 文档规划相关 hunks，避免混入他人代码和文档改动。

下一步：

- 当前活动路线图仍建议启动 S64.1；S71 排在现有 S70 规划之后，除非用户明确要求优先深化书生科举体验。
