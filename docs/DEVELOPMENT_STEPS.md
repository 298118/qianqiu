...
- 当前下一步是 S76.1：把主卷整理为顶栏、叙事卷、场景插画带、功能页签和底部奏折组成的清爽主游戏壳。
...
当前已知遗留：浏览器级 `prefers-reduced-motion` context 深测留给 S77.6；真实专题 `surface` 来源和完整专题 composer 留给 S76.11；S76.1 先推进主游戏壳。
