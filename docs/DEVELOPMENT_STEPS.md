...
本轮 S88.6 长链路后果回响与公开 echo ref 验证口径：
...
- `node --check src/game/roleCycleView.js`
- `node --check test/playerMonthlyBriefing.test.js`
- `node --check test/worldThreads.test.js`
- `node --check test/roleCycleView.test.js`
- `node --check test/roleCycleDomainAdjudication.test.js`
- `node --test --test-reporter=spec test/domainConsequenceTrace.test.js test/playerMonthlyBriefing.test.js test/worldThreads.test.js test/roleCycleView.test.js test/roleCycleDomainAdjudication.test.js`
