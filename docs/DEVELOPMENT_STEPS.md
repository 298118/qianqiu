...
| S61.1 | DONE | 国家与邻国深度内容包：财政、军事、国威、继承风险、外交、情报可信度和国策压力 | 2026-05-08 | Codex / 子代理 | 本次提交 |
| S61.2 | IN_PROGRESS | 城市与区域深度内容包：全国与邻国城市的税粮、市价、士绅、诉讼、水利、灾害、交通、驻军和书院 | - | Codex / 子代理 | - |
...
- 仍待后续切片：更大城市样本、事件档案/官职考成联动、浏览器分页搜索、城市指标随经济/军事/灾害系统演化。
