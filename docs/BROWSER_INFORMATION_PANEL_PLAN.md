...
| 事件档案 | `eventArchiveView` | `worldThreadView.recentResolved`、`longTermEventView.recentResolved`、`officialCareerView.recentOutcomes`、考试档案 | 按年月旬、来源和可见性整理已经发生或正在观察的事件。 | raw audit、provider proposal、完整 `eventHistory` 直出、隐藏事件、API key、本地路径。 |
