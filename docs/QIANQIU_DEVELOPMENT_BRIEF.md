...
- S70：AI 提示词、工具协议、actor 权限和多 AI 编排；S70.1 已落 prompt/tool 契约、工具协议 schema 和 MiMo 工具 smoke，S70.2 已落 actor profile 与权限 allowlist，S70.3 已落内部工具 registry/runner，S70.4 已落 NPC mind 基础、启发式 proposal 和可见记忆候选，后续从 S70.5 制度 AI 与朝议/科场场景继续。
