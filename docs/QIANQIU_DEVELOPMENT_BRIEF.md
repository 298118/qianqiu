...
- S70：AI 提示词、工具协议、actor 权限和多 AI 编排；S70.1 已落 prompt/tool 契约、工具协议 schema 和 MiMo 工具 smoke，S70.2 已落 actor profile 与权限 allowlist，后续从 S70.3 内部工具 registry/runner 继续。
