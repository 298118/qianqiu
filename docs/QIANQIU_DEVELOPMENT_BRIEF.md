...
- [DATABASE_GAMEPLAY_RESOLVER_ROADMAP.md](DATABASE_GAMEPLAY_RESOLVER_ROADMAP.md)：S71 数据库玩法化、维护、安全检索、redacted API、玩法 resolver、actor 场景、NPC 记忆和 AI 调动审计面板任务书；S71.11 已按该路线提供 hidden-safe AI 调动审计面板。
