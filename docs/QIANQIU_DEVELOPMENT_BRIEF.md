...
- S70：AI 提示词、工具协议、actor 权限和多 AI 编排；S70.1 已落 prompt/tool 契约、工具协议 schema 和 MiMo 工具 smoke，S70.2 已落 actor profile 与权限 allowlist，S70.3 已落内部工具 registry/runner，S70.4 已落 NPC mind 基础、启发式 proposal 和可见记忆候选，S70.5 已落朝议/科场制度场景 helper，S70.6 已落压力事件工具协议与 actor proposal，S70.7 已落刑名、财政、军事、外交与科举领域工具，S70.8 已落多模型路由与本地 eval runner，后续从 S70.9 AI 设置与可观测性继续。
