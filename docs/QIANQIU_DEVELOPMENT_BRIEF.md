...
- S61：国家/邻国、城市/区域深度内容。S61.1 国家深度字段已完成；S61.2 城市深度字段基础已接入任所考成与事件档案，但仍需继续补浏览器分页、更大 fixture、dual-mode 污染探针和城市指标随经济/军事/灾害系统演化。
