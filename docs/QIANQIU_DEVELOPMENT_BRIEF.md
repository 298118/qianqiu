...
- S73-S77：当前活动方向为前端水墨重构，任务书见 [FRONTEND_INK_REDESIGN_ROADMAP.md](FRONTEND_INK_REDESIGN_ROADMAP.md)；S73 从视觉资产指南、UI manifest、素材台账和视觉审核流程开始，S74-S77 再推进前端拆分、首页/全局 shell、身份/场景专题界面和验收归档。
