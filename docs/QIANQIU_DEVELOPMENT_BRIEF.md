...
- S71：数据库玩法化、维护、安全检索和 redacted API，S71.0 契约已固定在 [DATABASE_RESOLVER_INPUT_CONTRACT.md](DATABASE_RESOLVER_INPUT_CONTRACT.md)，S71.1 已落地只读 `resolverInputContext` 输入层，S71.2 已落地本地 SQLite migration/maintenance 初版，S71.3 已落地安全全文检索 / 本地搜索，S71.4 已落地 redacted player API 与本机开发诊断 API，S71.5 已落地财政与城市政策服务器 resolver，S71.6 已落地地方案件与刑名服务器 resolver；安全 projection、本地维护工具、snippet 搜索、玩家/诊断分层和 proposal-only 工具边界将继续作为军务、外交、压力事件和 AI 审计面板的基础。
