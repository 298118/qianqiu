...
- S71：数据库玩法化、维护、安全检索和 redacted API，当前从 S71.0 启动；重点是让安全 projection 成为财政、地方政策、案件、军务、外交和事件链 resolver 的输入，补 `schema_migrations`、本地维护、FTS/安全搜索、AI actor 场景、NPC 记忆和 AI 调动审计面板。
